    ...
    public partial class Header : System.Web.UI.UserControl
    {
        ...
        private void SetMenuPermission()
        {
            if (Session["PermissionString"] != null)
            {
                ...
                tdManufacturer.Visible = permisString[2] == '1';
                tdNews.Visible = permisString[3] == '1';
                tdNewsCategory.Visible = permisString[4] == '1';
            ...
            if (Session["LoginInfo"] != null)
            {
                ...
                tdStockStatus.Visible = isAdmin;
                tdTaxClass.Visible = isAdmin;
                tdWeightClass.Visible = isAdmin;
