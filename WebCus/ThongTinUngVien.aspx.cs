...
namespace WebCus
{
    public partial class ThongTinUngVien : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (type ==3)
                {
                    this.a3.Style.Add("background-color", "#005399");
                    this.a3.Style.Add("color", "white");
                    this.a3.Style.Add("border-bottom", "4px solid #033c74");
                }
                if (type == 4)
                {
                    this.a4.Style.Add("background-color", "#005399");
                    this.a4.Style.Add("color", "white");
                    this.a4.Style.Add("border-bottom", "4px solid #033c74");
                }
                if (type == 5)
                {
                    this.a5.Style.Add("background-color", "#005399");
                    this.a5.Style.Add("color", "white");
                    this.a5.Style.Add("border-bottom", "4px solid #033c74");
                }
                if (type == 6)
                {
                    this.a6.Style.Add("background-color", "#005399");
                    this.a6.Style.Add("color", "white");
                    this.a6.Style.Add("border-bottom", "4px solid #033c74");
                }
                if (type == 7)
                {
                    this.a7.Style.Add("background-color", "#005399");
                    this.a7.Style.Add("color", "white");
                    this.a7.Style.Add("border-bottom", "4px solid #033c74");
                }
                if (type ==8)
                {
                    this.a8.Style.Add("background-color", "#005399");
        ...
        {
            IList<VM_YeuCauTuyenDung> lstPhongban = blc_user.ListVMYCTD().Where(m=>m.TrucThuoc==int.Parse(drop_tructhuoc.SelectedValue.ToString())).OrderByDescending(m=>m.NgayTao).ToList();
        ...
        private void BindGird(int idyeucautuyendung,int type)
        {
            int userid = 0;
        ...
        protected void gvBanner_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "DongBoItem")
            {
                ...
                if (ent != null)
                {
                    ...
                    dbnv.NgaySinh = ent.NgaySinh.HasValue? ent.NgaySinh.Value:DateTime.Now;
                    dbnv.CMND = ent.CMND;
                    dbnv.NgayCMND = ent.NgayCMND.HasValue? ent.NgayCMND:DateTime.Now;
                    ...
                    if (ent.IdNhanVien == null)
                    {
                        ...
                        //  
                        tuser.UserLike = yctd.TrucThuoc.Value;
                        tuser.ParentID = yctd.IDPhongBan.Value;
                        tuser.PermissionString = "0";
                        tuser.ModifyUser = 0;
    ...
    "y","y","y","y","y",};
        ...
        {
            var id = Guid.Parse(Page.Request.Form["ctl00$MainContent$ipungvien"].ToString());
            var rad = Page.Request.Form["ctl00$MainContent$ttpv"].ToString();
            int Type = 0;
            Type = int.Parse(rad.Replace("ip", ""));

            //ttnv
            int Type2 = 0;
            if (Page.Request.Form["ctl00$MainContent$ttnv"] != null)
            {
                var rad2 = Page.Request.Form["ctl00$MainContent$ttnv"].ToString();
        ...
        public string CheckChucnangNhapThongtin(Guid id)
        {
            ...
            string wordIcon = " <img style='width:13px; position: relative;left:11px;top: -1px;' src=\"Images/wordicon.png\"/>";
        ...
        public string CheckChucnangPhongvan(Guid id)
        {
            ...
            if (uvStatus.NgayNhapThongTin.HasValue)
            {
                ...
                {
                    strResult += "<a style='position:relative' class='btnphongvan' onclick =\"ShowPopupMapLink('" + id + "')\" >" + input + " Mời phỏng vấn</a>";
                    strResult += "<a style='position:relative;margin-left:10px;' class='btnphongvan' onclick =\"Boqua('" + id + "')\" > Bỏ qua</a></div>";
                }
        ...
        public string CheckChucnangDanhGia(Guid id)
        {
            ...
            if (uvStatus.NgàyPV != null)
            {
                ...
                strResult += "<div class='hcnsdanhgia'><a style='position:relative' class='btnDanhgia' onclick =\"ShowPopupMapLink2('" + id + "')\" >" + input + "HCNS Đánh giá </a></div>";
                ...
                //if (uvStatus.NguoiPVDanhGia != null)
                //{
                //    TUser tnguoidanhgia = blc_user.GetUser_ByIDAll(uvStatus.NguoiPVDanhGia.Value);
                //    strResult += "<div><strong>Người đánh giá: " + tnguoidanhgia.UserName + "</strong></div>";
                //}
                ...
                //if (uvStatus.NguoiDuyetDanhGia != null)
                //{
                //    TUser tnguoidanhgia = blc_user.GetUser_ByIDAll(uvStatus.NguoiDuyetDanhGia.Value);
                //    strResult += "<div><strong>Người đánh giá: " + tnguoidanhgia.UserName + "</strong></div>";
                //}
                if (uvStatus.NgayDanhgia.HasValue)
                {
        ...
        public string CheckChucnangMoinhanviec(Guid id)
        {
            ...
            {
                strResult += "<a style='position:relative;pointer-events: none;' class='btnGuithunhanviec' onclick =\"ShowPopupMapLink3('" + id + "')\" >" + input + "Gửi thư nhận việc</a>";

                strResult += "<a class='importfile' onclick=\"importTMNV('" + id + "')\">Import file" + wordIcon + "</a></div>";
            }
            else
            {
                strResult += "<a style='position:relative' class='btnGuithunhanviec' onclick =\"ShowPopupMapLink3('" + id + "')\" >" + input + "Gửi thư nhận việc</a>";
                strResult += "<a class='importfile' onclick=\"importTMNV('" + id + "')\">Import file" + wordIcon + "</a></div>";
            }
            if (uvStatus.NgayGuithumoi.HasValue)
            {
        ...
        public string CheckGTNV(string path)
        {
            if (path != "")
            {
                return "<a href=\"Uploads/TuyenDung/ThuMoiNhanViec/" + path+"\" >Tải File</a>";
            }
            return "";
        }
        ...
        public string Checkchucnangquytrinh(Guid id)
        {
            ...
            if (uvStatus.Ngaydongbo != null)
            {
                ...
                strResult += "<a style='position:relative;padding-left: 30px;' href='Tomtatquytrinh.aspx?id=" + id + "' target='_blank' class='btnTomTatQuyTrinh'>" + ip1 + "Tóm tắt quy trình</a>";
                strResult += "<a style='position:relative;padding-left: 30px;' href='Tomtatphucloi.aspx?id=" + id + "' target='_blank' class='btnTomtatphucloi'>" + ip2 + "Tóm tắt phúc lợi</a>";
            ...
            foreach (Microsoft.Office.Interop.Word.Table tb in doc.Tables)
            {
                ...
                for (int row = 1; row <= 73; row++)
                {
                   ...
                   //Table 1
                    ...
                    {
                        var cell = tb.Cell(row, 1);
                        var text = cell.Range.Text.Replace("\r\a", "").Replace("\a", "").Replace("Lương khởi điểm:", "").Trim();
                        var cell2 = tb.Cell(row, 2);
                        var text2 = cell2.Range.Text.Replace("Lương sau cùng:", "").Trim();
                        qtlv1.Luongkhoidiem = text.Replace("\r\a", "");
                        qtlv1.Luongsaucung = text2.Replace("\r\a", "");
                    }
                    if (row == 59)
                    {
                        var cell = tb.Cell(row, 1);
                    ...
                    if (row == 63 && qtlv2.TenCongTy != "")
                    {
                        ...
                        var cell2 = tb.Cell(row, 2);
                        var text2 = cell2.Range.Text.Replace("Lương sau cùng:", "").Trim();
                        qtlv2.Luongkhoidiem = text.Replace("\r\a", "");
                        qtlv2.Luongsaucung = text2.Replace("\r\a", "");
                    }
        ...
        public string GetTrangThaiUngVien(Guid id)
        {
            ...
            if (uv != null)
            {
                if (uv.TrangThaiPhongVan == 0 && uv.TrangThaiNhanViec == 0)
                    return "" + "<a class=\"btnCapnhat\" onclick=\"capnhattrangthai('" + id + "','" + uv.HoTen + "','" + uv.TrangThaiPhongVan + "','" + uv.TrangThaiNhanViec + "')\">Cập nhật</a>";
                if (uv.TrangThaiPhongVan == 1 && uv.TrangThaiNhanViec==0)
                    return "Đạt" + "<a class=\"btnCapnhat\" onclick=\"capnhattrangthai('" + id + "','"+uv.HoTen+"','"+uv.TrangThaiPhongVan+"','"+uv.TrangThaiNhanViec+"')\">Cập nhật</a>";
                if (uv.TrangThaiPhongVan == 2 && uv.TrangThaiNhanViec == 0)
                    return "Không đạt" + "<a class=\"btnCapnhat\" onclick=\"capnhattrangthai('" + id + "','" + uv.HoTen + "','" + uv.TrangThaiPhongVan + "','" + uv.TrangThaiNhanViec + "')\">Cập nhật</a>";
                if (uv.TrangThaiPhongVan == 3 && uv.TrangThaiNhanViec == 0)
                    return "UV Suy nghĩ thêm" + "<a class=\"btnCapnhat\" onclick=\"capnhattrangthai('" + id + "','" + uv.HoTen + "','" + uv.TrangThaiPhongVan + "','" + uv.TrangThaiNhanViec + "')\">Cập nhật</a>";
                if (uv.TrangThaiPhongVan == 4 && uv.TrangThaiNhanViec == 0)
                    return "Từ chối phỏng vấn" + "<a class=\"btnCapnhat\" onclick=\"capnhattrangthai('" + id + "','" + uv.HoTen + "','" + uv.TrangThaiPhongVan + "','" + uv.TrangThaiNhanViec + "')\">Cập nhật</a>";
                if (uv.TrangThaiNhanViec == 5)
                    return "Đang thử việc" + "<a class=\"btnCapnhat\" onclick=\"capnhattrangthai('" + id + "','" + uv.HoTen + "','" + uv.TrangThaiPhongVan + "','" + uv.TrangThaiNhanViec + "')\">Cập nhật</a>";
                if (uv.TrangThaiNhanViec == 6)
                    return "NV chính thức" + "<a class=\"btnCapnhat\" onclick=\"capnhattrangthai('" + id + "','" + uv.HoTen + "','" + uv.TrangThaiPhongVan + "','" + uv.TrangThaiNhanViec + "')\">Cập nhật</a>";
                if (uv.TrangThaiNhanViec == 7)
                    return "Không phù hợp" + "<a class=\"btnCapnhat\" onclick=\"capnhattrangthai('" + id + "','" + uv.HoTen + "','" + uv.TrangThaiPhongVan + "','" + uv.TrangThaiNhanViec + "')\">Cập nhật</a>";
                if (uv.TrangThaiNhanViec == 8)
