...
<div class="TboardBox">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="tb_input" runat="server" visible="true">
        ...
        <tr>
            ...
            <td class="RB_L">
               <asp:DropDownList ID="dr_Cty" runat="server" Width="200px">
        ...
        <tr>
            ...
            <td class="RB_L">
                <asp:DropDownList ID="dr_typephong" runat="server" AutoPostBack="true" 
                    onselectedindexchanged="dr_typephong_SelectedIndexChanged" Width="200px">
        ...
        <tr>
            <th width="15%" class="RB_L">
                <asp:Label ID="lbl_name" runat="server" Text="Tên Phòng-Bộ Phận"></asp:Label>
            </th>
            <td class="RB_L">
        ...
        <tr id="tr_thuocphong" runat="server">
            ...
            <td class="RB_L">
                <asp:DropDownList ID="dr_phongban" runat="server"  Width="200px">                     
                </asp:DropDownList>
            </td>
        </tr>
                ...
                <asp:GridView ID="gvBanner" runat="server" Width="100%" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Trực Thuộc">
                            <ItemTemplate>
                                <%#string.Format("{0}",Eval("TrucThuoc").ToString()=="1" ? "Nguyên Kim" : ( Eval("TrucThuoc").ToString()=="2" ? "Chính Nhân" : "SMC" ))%>
                            </ItemTemplate>
                            <HeaderStyle CssClass="RB_C"/>
                            <ItemStyle CssClass="RB_L" />
                        </asp:TemplateField>
