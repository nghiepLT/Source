...
<div class="page-title">
    <h2 class="icon-title">
        <span>Cập nhật thông tin kỹ thuật</span>
    </h2>
</div>
<br>
    ...
    <tbody>
        <tr>
            ...
            <td class="R">
                ...
                &nbsp;
                <asp:Button ID="btnDelete" runat="server" Text="Xóa" CssClass="btn-1" OnClick="btnDelete_Click" /></b>
            </td>
        </tr>
    </tbody>
</table>
<div class="TboardBox">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="tbttkt" runat="server">
        ...
        <tr id="trUserType" runat="server" visible="true">
            <th width="20%" class="RB_L">
                <asp:Label ID="Label6" runat="server" Text="Loại TK"></asp:Label>
            </th>
            <td class="B_L">
                ...
                <%--  <asp:ListItem Text="SupperAdmin" Value="1"></asp:ListItem>--%>
                  ...
                  <%--  <asp:ListItem Text="Group kinh doanh"  Value="3"></asp:ListItem>--%>
                    <asp:ListItem Text="KT Hỗ Trợ"  Value="4"></asp:ListItem>
                   <%-- <asp:ListItem Text="NV Kinh Doanh" Value="5"></asp:ListItem>--%>
                    <asp:ListItem Text="KT Hệ Thống"  Value="40"></asp:ListItem>
        ...
        <tr>
            <th width="20%" class="RB_L">
                <asp:Label ID="Label4" runat="server" Text="Level Kỹ Thuật"></asp:Label>
            </th>
            <td class="B_L">
            ...
            <td class="B_L" colspan="3">
            <asp:RadioButton ID="rd_buoisang" runat="server" GroupName="nghiphep" Text="Nghỉ Phép Sáng" /><br />
            <asp:RadioButton ID="rd_buoichieu" runat="server" GroupName="nghiphep" Text="Nghỉ Phép Chiều" /><br />
            <asp:RadioButton ID="rd_phepngay" runat="server" GroupName="nghiphep" Text="Nghỉ Phép Ngày " />|
           Số Ngày Nghỉ :  <asp:TextBox ID="txt_songaynghi" runat="server" Text="1" TextMode="Number" Width="35px"></asp:TextBox> <br />
