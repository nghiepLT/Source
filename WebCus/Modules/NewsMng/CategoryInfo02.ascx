...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tbody>
        <tr>
            <td><asp:Label style="color:red;font-weight:bold;" ID="lbl_title_pro" runat="server" Text=""></asp:Label>
                &nbsp;
            </td>
            <td class="R">
                ...
                &nbsp;
                <asp:Button ID="btnInsert" runat="server" Text="Tạo mới" CssClass="btn-1"
                    OnClick="btnInsert_Click" />
                &nbsp;
                <asp:Button ID="btnSave" runat="server" Text="Lưu" CssClass="btn-1" OnClientClick="return CheckValidate();"
                    OnClick="btnSave_Click" />
                    <div style="float:right;margin-left:10px;">
                <a href="/RenderModule.aspx?smid=ProductMng&md=ProductControl.ascx&muid=ProductList&divmeta=1" style="width:100px;" class="btn-1" id="pro_list" runat="Server" visible="false">
                    Về danh sách
                </a>
                </div>
            </td>
...
<div class="TboardBox">
        ...
        <tr>
            <td width="20%" class="T" id="tdCategory" runat="server">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td class="pdL5 L ">
                            <asp:Panel ID="Panel1" Height="600px" Width="100%" ScrollBars="Auto" runat="server">
    ...
    <div id="divImageProduct" style="background-color: Gray; display:none;padding: 2px">
        <div style="padding: 3px; background-color: White">
            <asp:Image ID="imgProduct" runat="server" Width="300px" />
        </div>
    </div>
    <div id="divImageIcon" style="background-color: Gray;display:none; padding: 2px">
        <div style="padding: 3px; background-color: White">
