<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TThongKePhep.ascx.cs"
    Inherits="WebCus.TThongKePhep" %>
...
<script language="JAVASCRIPT" type="text/javascript">
 ...
 function CheckAddValue() {
  ...
  function ToggleSecondPopup3()
    ...
    function ToggleTTFormDate()
    {
       <%= rad_ttFormDate.ClientID %>.ShowPopup();
    }
     function ToggleTTToDate()
    {
       <%= rad_ttToDate.ClientID %>.ShowPopup();
    }
</script>
<script language="javascript" type="text/javascript">
...
<div class="page-title" style="font-size: 15px;display:none;">
    <asp:Literal ID="Literal1" runat="server"></asp:Literal>
</div>
<div class="TboardBox" id="tbttkt" runat="server">
    <legend class="page-title" style="font-size: 15px;">Thống kê ngày nghĩ nhân viên :
        <asp:Label ID="lbltennv" Style="color: Red;" runat="server"></asp:Label>
    </legend>
    <div>
        Tổng ngày nghĩ trong năm
        <%=DateTime.Now.Year %>:
        <asp:Label Style="color: Red;" ID="lbl_nghinamnv" runat="server"></asp:Label></div>
    <div>
        Số ngày nghĩ trong tháng
        <%=DateTime.Now.Month %>:
        <asp:Label Style="color: Red;" ID="lbl_nghithangnv" runat="server"></asp:Label></div>
    <div>
        Tổng số lần đi trễ trong tháng
        <%=DateTime.Now.Month %>
        :
        <asp:Label Style="color: Red;" ID="lbl_ditrenv" runat="server"></asp:Label></div>
    <div>
        Tổng số lần về sớm trong tháng
        <%=DateTime.Now.Month %>
        :
        <asp:Label Style="color: Red;" ID="lbl_vesomnv" runat="server"></asp:Label></div>
    <div>
        Số lần công tác ngoài trong tháng
        <%=DateTime.Now.Month %>
        :
        <asp:Label Style="color: Red;" ID="lbl_congtacngoainv" runat="server"></asp:Label></div>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr id="tr_macv" runat="server">
            ...
            <td class="B_L" width="30%" id="td_buoi" runat="server">
                ...
                <asp:DropDownList ID="dr_buoinghi" runat="server" CssClass="demo-default" Width="50%">
        ...
        <tr id="tr_tenkh" runat="server">
            <th width="20%" class="RB_L">
                <asp:Label ID="Label12" runat="server" Text="Lý Do"></asp:Label>
            </th>
            <td class="B_L" width="30%">
            ...
            <tr class="trLabelFilter1">
                ...
                <td class="pd5">
                    <asp:Button ID="btn_duyetphep" Width="120px" CommandArgument="1" CssClass="btn-1"
                        Text="Duyệt Phép" runat="server" OnClick="btnUpdate_Status_Click"></asp:Button>
                </td>
            </tr>
        </table>
    </fieldset>
...
<hr />
<asp:RadioButton GroupName="tknv" ID="rd_1" runat="server"
    Text="Thống Kê Chi Tiết Ngày Phép" AutoPostBack="true"  CssClass="btn-1"
    oncheckedchanged="rd_1_CheckedChanged" />
<asp:RadioButton GroupName="tknv" ID="rd_2" runat="server" CssClass="btn-1"
    Text="Thống Kê Tổng Ngày Phép" oncheckedchanged="rd_2_CheckedChanged" AutoPostBack="true"/>
<hr />
<table cellpadding="0" cellspacing="0" id="tbl_ctcontrol" runat="server">
    ...
    <tr class="trLabelFilter1">
        ...
        <td>
            ...
            <asp:DropDownList ID="dr_dspb" CssClass="select" Width="150px" runat="server" OnSelectedIndexChanged="dr_dspb_SelectedIndexChanged"
                AutoPostBack="true">
            </asp:DropDownList>
...
<div class="TboardBox" id="tblData" runat="server">
    <div>
        <asp:Button ID="Button1" runat="server" Text="Quay lại" CssClass="btn-1" OnClick="btn_rebackData" />
    </div>
    <br />
...
<table cellpadding="0" cellspacing="0" id="tbl_Tongcontrl" runat="server">
<tr class="trLabelFilter1">
<td colspan="2">
    ...
    <tr class="trLabelFilter1">
        <td>
            <radCln:RadDatePicker ID="rad_ttFormDate" CssClass="datePicker" Width="100px" AllowEmpty="false"
                MinDate="1911-01-01" runat="server" MaxDate="2199-12-16" Calendar-BackColor="#CCCCCC">
                <DateInput DisplayPromptChar="_" PromptChar=" " onclick="ToggleTTFormDate()" DateFormat="dd/MM/yyyy">
        ...
        <td>
            <radCln:RadDatePicker ID="rad_ttToDate" CssClass="datePicker" Width="100px" AllowEmpty="false"
                MinDate="1911-01-01" runat="server" MaxDate="2199-12-16" Calendar-BackColor="#CCCCCC">
                <DateInput DisplayPromptChar="_" PromptChar=" " onclick="ToggleTTToDate()" DateFormat="dd/MM/yyyy">
                </DateInput>
                <PopupButton Visible="False"></PopupButton>
            </radCln:RadDatePicker>
        </td>       
        ...
        <%--<td>
            <asp:DropDownList ID="DropDownList3" CssClass="select" Width="150px" runat="server"
                OnSelectedIndexChanged="dropSearchtype_SelectedIndexChanged" AutoPostBack="true">
                <asp:ListItem Text="Tất Cả" Value="-1"></asp:ListItem>
                <asp:ListItem Text="Phòng Ban" Value="1"></asp:ListItem>
                <asp:ListItem Text="Tên Nhân Viên" Value="2"></asp:ListItem>
        ...
        <%--<td>
            <asp:DropDownList ID="DropDownList4" CssClass="select" Width="150px" runat="server" Visible="false"
                AutoPostBack="true" OnSelectedIndexChanged="dr_cty_SelectedIndexChanged">
                <asp:ListItem Text="--Chọn Cty--" Value="-1"></asp:ListItem>
                <asp:ListItem Text="Nguyên Kim" Value="1"></asp:ListItem>
                <asp:ListItem Text="Chính Nhân" Value="2"></asp:ListItem>
            </asp:DropDownList>
            <asp:DropDownList ID="DropDownList5" CssClass="select" Width="150px" runat="server" OnSelectedIndexChanged="dr_dspb_SelectedIndexChanged"
                AutoPostBack="true">
            </asp:DropDownList>
            <asp:TextBox ID="TextBox1" CssClass="Input_text" runat="server"></asp:TextBox>
        </td>--%>
        <td>
            <asp:Button ID="Button6" CssClass="btn-1" runat="server" Text="Xem" OnClick="btnSearchTotal_Click" />
            &nbsp;&nbsp;&nbsp;
            <asp:Button ID="Button7" Visible="false" CssClass="btn-1" runat="server" Text="Xuất Excell"
                OnClientClick="ExporttoExcel('tblData','Danh_sach_don_hang'); return false;" />
            <button id="Button8" class="btn-1" onclick="excellexport();" style="display: none;">
                Xuất Excell</button>
        </td>
    </tr>
</table>
<hr />
<div id="dstonghop" class="TboardBox" runat="server">
<div>
        <asp:Button ID="Button5" runat="server" Text="Quay lại" CssClass="btn-1" OnClick="btn_rebackData" />
    </div>
    <br />
    <table width="100%" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td>
                <asp:GridView ID="Gr_dstonghop" runat="server" CssClass="infotable" AutoGenerateColumns="false"
                    AlternatingRowStyle-CssClass="row" RowStyle-CssClass="row-alt" OnRowCommand="gvList_RowCommand1"
                    OnRowDataBound="gvList_RowDataBound" Width="100%" AllowSorting="true" 
                    onsorting="Gr_dstonghop_Sorting" >
                    <%--<Columns>
                        <asp:TemplateField HeaderText="checkallid" ItemStyle-CssClass="C" Visible="false">
                            <HeaderTemplate>
                                Check ALL
                    ...
                    <Columns>
                    <asp:BoundField DataField="TotalDiTre" HeaderText="Số lần đi trễ (Click Sort)" SortExpression="TotalDiTre" ItemStyle-Width="40px" HeaderStyle-Width="40px" HeaderStyle-CssClass="RB_L" ItemStyle-CssClass="RB_L"/>
                  </Columns>
                    <%--<Columns>
                        <asp:TemplateField HeaderText="">
                            <HeaderTemplate>
                    ...
                    <Columns>
                    <asp:BoundField DataField="TotalVeSom" HeaderText="Số lần về sớm (Click Sort)" SortExpression="TotalVeSom" ItemStyle-Width="50px" HeaderStyle-Width="50px" HeaderStyle-CssClass="RB_L" ItemStyle-CssClass="RB_L"/>
                   </Columns>
                    <%--<Columns>
                        <asp:TemplateField HeaderText="">
                            <HeaderTemplate>
                    ...
                    <Columns>
                    <asp:BoundField DataField="TotalCongTacNgoai" HeaderText="C.Tác ngoài (Click Sort)" SortExpression="TotalCongTacNgoai" ItemStyle-Width="40px" HeaderStyle-Width="40px" HeaderStyle-CssClass="RB_L" ItemStyle-CssClass="RB_L"/>
                   </Columns>
                    <%--<Columns>
                        <asp:TemplateField HeaderText="">
                            <HeaderTemplate>
                    ...
                    <Columns>
                    <asp:BoundField DataField="TotalNgayNghi" HeaderText="Số ngày nghỉ (Click Sort)" SortExpression="TotalNgayNghi" ItemStyle-Width="50px" HeaderStyle-Width="50px" HeaderStyle-CssClass="RB_L" ItemStyle-CssClass="RB_L" />
                   </Columns>
                    <%--<Columns>
                        <asp:TemplateField HeaderText="">
                            <HeaderTemplate>
                    ...
                    <%--<Columns>
                        <asp:TemplateField HeaderText="SoNgayNghi">
                            <HeaderTemplate>
                             Tổng Số Ngày Nghỉ Năm <span style="color:Red;"> <%=DateTime.Now.Year %> </span>
                            </HeaderTemplate>
                            <ItemTemplate>                                
                                <%#Eval("TotalNgayNghi")%>
                            </ItemTemplate>
