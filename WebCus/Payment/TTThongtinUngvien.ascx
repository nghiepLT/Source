<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TTThongtinUngvien.ascx.cs" 
    Inherits="WebCus.TTThongtinUngvien" %>
        ...
        <tr>
            <td>
               <div style="overflow:scroll">
                    <asp:GridView ID="gvBanner" runat="server" Width="290%" AutoGenerateColumns="False"
    ...
    function sendFile(file) {
        ...
        $.ajax({
            ...
            success: function (status) {
                ...
                $.ajax({
                    type: "POST", //POST
                    url: "TTThongtinUngvien.ascx/UploadFileUngvien",
                    data: "{path:'" + status+"'}",
