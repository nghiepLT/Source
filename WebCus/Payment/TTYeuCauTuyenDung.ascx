                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Trạng thái">
                            <ItemTemplate>
                               ...
                               <div>
                                    <a onclick="tgTTTD(<%#Eval("IdYeuCau")%>)" class="btn-capnhattttd">Cap nhat</a>
                               </div>
                            </ItemTemplate>
...
<div id="mymodal">
    ...
    <div class="ttpv_box"> 
        <div class="ttpv_title2">
            <ul>
                <li>
                    <input id="radDangTuyendung" type="radio" name="tttd" /> <span>Đang tuyển dụng</span>
                </li>
                <li>
                    <input id="radDaHoanThanh" type="radio"  name="tttd"/> <span>Đã hoàn thành</span>
                </li>
            </ul>
        </div>
    </div>
...
<script>
    function CheckValidBanner() {
        ...
        if ($("#ctl00_MainContent_TTYeuCauTuyenDung_filepath").html() == null || $("#ctl00_MainContent_TTYeuCauTuyenDung_filepath").html() == '') {
