    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <td class="RB_L">
                ...
                <asp:FileUpload ID="fileImage" runat="server" Width="200px" Height="20px" />
            </td>
        ...
        <tr>
            ...
            <td class="RB_L">
                <asp:TextBox ID="txtSortOrder" runat="server" CssClass="Input_text" Width="200px"></asp:TextBox>
            </td>
        </tr>
    </table>
                ...
                <asp:GridView ID="gvBanner" runat="server" Width="100%" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Tên">
                            <ItemTemplate>
                                &nbsp;
                                <asp:LinkButton ID="lnkLink" runat="server" Text='<%#Eval("Name")%>' CommandName="EditItem"
