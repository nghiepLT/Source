...
<div class="TboardBox">
        ...
        <tbody>
            <tr>
                ...
                <td class="R">
                    ...
                    &nbsp;
                    <asp:Button ID="btnSaveBanner" runat="server" Text="Lưu" CssClass="btn-1" OnClick="btnSaveBanner_Click" Visible="false"/>
                    &nbsp;
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
        ...
        <tr>
            ...
            <th width="15%" class="RB_L">
                <asp:Label Visible="false" ID="Label8" runat="server" Text="Ngày sinh"></asp:Label>
            </th>
            <td class="B_L">
                <asp:Label Visible="false" ID="lbl_brithday" runat="server"></asp:Label>
            </td>
        </tr>
        ...
        <tr >
            ...
            <th width="15%" class="RB_L" style="display:none;">
                <asp:Label ID="Label13" runat="server" Text="Bài viết"></asp:Label>
            </th>
            <td class="B_L" style="display:none;">
