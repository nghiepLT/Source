            ...
            if (idsend != 0 && !string.IsNullOrEmpty(uvdata))
            {
                ...
                { 
                    ...
                    if (thoigiansd.Days == 7)
                    {
                        ...
                        string contentHtml = "";
                        contentHtml += "<div>";
                        contentHtml += "<div>Chào bạn "+item.NhanVien.HoTen.ToUpper()+",</div>";
                        contentHtml += "<div>Sau 07 ngày làm việc, bạn vui lòng đăng nhập vào hệ thống CMS để đánh giá.</div>";
                        contentHtml += "</div>";
                    ...
                    if (thoigiansd.Days == 14)
                    {
                        ...
                        contentHtml += "<div>";
                        contentHtml += "<div>Chào bạn " + item.NhanVien.HoTen.ToUpper() + ",</div>";
                        contentHtml += "<div>Sau 14 ngày làm việc, bạn vui lòng đăng nhập vào hệ thống CMS để đánh giá.</div>";
                        contentHtml += "</div>";
                        sendEmail7ngay(item.NhanVien.Email, "Khảo sát đánh giá sau 07 ngày làm việc - " + item.NhanVien.HoTen.ToUpper(), contentHtml);
                    }
                    if (thoigiansd.Days == 60)
                    {
                        ...
                        contentHtml += "<div>";
                        contentHtml += "<div>Chào bạn " + item.NhanVien.HoTen.ToUpper() + ",</div>";
                        contentHtml += "<div>Sau 2 tháng làm việc, bạn vui lòng đăng nhập vào hệ thống CMS để đánh giá.</div>";
                        contentHtml += "</div>";
