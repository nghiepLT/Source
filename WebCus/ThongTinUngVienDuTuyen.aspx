...
thông tin ứng viên cung cấp sẽ được bảo mật)
                    ...
                    <div class="table_1">
                        <table class="table">
                            ...
                            <%-- TÍNH CÁCH CÁ NHÂN--%>
                            <tr>
                                <td colspan="4">TÍNH CÁCH CÁ NHÂN
                                </td>
                                <td colspan="2">NĂNG LỰC VƯỢT TRỘI KHÁC
                                </td>
                            </tr>
                            <tr>
                                <td class="tdgray" colspan="2">Điểm yếu
                                </td>
                    ...
                    <div class="headertitle_box">
                        ...
                        <div class="headertitle_box_right">
                            <div class="headertitle_box_right_title" style="font-size: 20px;">
                                BẢN KHẢO SÁT PHỎNG VẤN DÀNH CHO ỨNG VIÊN
                            </div>
                        </div>
                        <div class="clearfix">
                        </div>
                    </div>
                    <div class="khaosat_box">
                        <div class="ks_title">
                            <strong style="margin-right:15px;">I.</strong><strong style="text-decoration:underline">ĐỊNH HƯỚNG</strong>
                        </div>
                        <div class="neudinhhuong">
                            Nêu các định hướng của cá nhân
                        </div>
                        <div>
                        ...
                        <div>
                            Các anh chị có <strong style="font-style:italic">đồng ý với chính sách sau</strong> của công ty Nguyên Kim hay không (chỉ cần đánh dấu vào các ô Có hoặc Không)    
                        </div>
                        <div class="ks_csphucloi">
                            <ul>
                                <li class="w60"><span style="margin-left:20px;margin-right:15px;">-</span> <span>Chính sách lương cứng (lương cơ bản): Nhận hàng Tháng</span>
                                </li>
                                <li class="w10">: Có
                                    <input name="radCSLuongcung" id="radCSLuongcung1" runat="server" type="radio" />
                                </li>
                                <li class="w10">Không 
                                    <input name="radCSLuongcung" id="radCSLuongcung2" runat="server" type="radio" />
                                </li>
                            </ul>
                        </div>
                        <div class="ks_csphucloi">
                            <ul>
                                <li class="w60"><span style="margin-left:20px;margin-right:15px;">-</span> Chính sách thưởng (Hiệu quả Công việc): Nhận hàng Quý
                                </li>
                                <li class="w10">
                                    <span class="w10">:</span> Có
                                    <input name="radCSThuong" id="radCSThuong1" runat="server" type="radio" />
                                </li>
                                <li class="w10">Không 
                                    <input name="radCSThuong" id="radCSThuong2" runat="server" type="radio" />
                                </li>
                            </ul>
                        </div>
                        <div class="ks_csphucloi">
                            <ul>
                                <li class="w60"><span style="margin-left:20px;margin-right:15px;">-</span>Chính sách lưu bằng gốc:	
                                </li>
                                <li class="w10">: Có
                                    <input name="radCSLuubanggoc" id="radCSLuubanggoc1" runat="server" type="radio" />
                                </li>
                                <li class="w10">Không 
                                    <input name="radCSLuubanggoc" id="radCSLuubanggoc2" runat="server" type="radio" />
                                </li>
                            </ul>
                        </div>
                        <div>
                            Anh chị có <strong style="font-style:italic">biết các chính sách,phúc lợi</strong> nào dưới đây công ty Nguyên Kim đang áp dụng:     
                        </div>
                        <div class="ks_csphucloi">
                            <ul>
                                <li class="w60"><span style="margin-left:20px;margin-right:15px;">-</span>Thưởng thâm niên (Hàng năm, 3 năm, 5 năm….): 
                                </li>
                                <li class="w10">: Có
                                    <input name="radThuongthamnien" id="radThuongthamnien1" runat="server" type="radio" />
                                </li>
                                <li class="w10">Không 
                                    <input name="radThuongthamnien" id="radThuongthamnien2" runat="server" type="radio" />
                                </li>
                            </ul>
                        </div>
                        <div class="ks_csphucloi">
                            <ul>
                                <li class="w60"><span style="margin-left:20px;margin-right:15px;">-</span>Thưởng XSCV, đóng góp sáng kiến…...	
                                </li>
                                <li class="w10">: Có
                                    <input name="radThuongXSCV" id="radThuongXSCV1" runat="server" type="radio" />
                                </li>
                                <li class="w10">Không 
                                    <input name="radThuongXSCV" id="radThuongXSCV2" runat="server" type="radio" />
                                </li>
                            </ul>
                        </div>
                        <div class="ks_csphucloi">
                            <ul>
                                <li class="w60"><span style="margin-left:20px;margin-right:15px;">-</span>Thưởng lương T13, các ngày lễ lớn.…..
                                </li>
                                <li class="w10">: Có
                                    <input name="radThuongluong13" id="radThuongluong131" runat="server" type="radio" />
                                </li>
                                <li class="w10">Không 
                                    <input name="radThuongluong13" id="radThuongluong132" runat="server" type="radio" />
                                </li>
                            </ul>
                        </div>
                        <div class="ks_csphucloi">
                            <ul>
                                <li class="w60"><span style="margin-left:20px;margin-right:15px;">-</span>Chính sách phúc lợi cưới hỏi, ốm đau....
                                </li>
                                <li class="w10">: Có
                                    <input name="radCSphucloihoicuoi" id="radCSphucloihoicuoi1" runat="server" type="radio" />
                                </li>
                                <li class="w10">Không 
                                    <input name="radCSphucloihoicuoi" id="radCSphucloihoicuoi2" runat="server" type="radio" />
                                </li>
                            </ul>
                        </div>
                        <div class="ks_csphucloi">
                            <ul>
                                <li class="w60"><span style="margin-left:20px;margin-right:15px;">-</span>Chính sách phúc lợi quà Tết, T.Thu……	
                                </li>
                                <li class="w10">: Có
                                    <input name="radCSPhucloiquatet" id="radCSPhucloiquatet1" runat="server" type="radio" />
                                </li>
                                <li class="w10">Không 
                                    <input name="radCSPhucloiquatet" id="radCSPhucloiquatet2" runat="server" type="radio" />
                                </li>
                            </ul>
                        </div>
                        <div class="ks_csphucloi">
                            <ul>
                                <li class="w60"><span style="margin-left:20px;margin-right:15px;">-</span>Chính sách mừng sinh nhật
                                </li>
                                <li class="w10">: Có
                                    <input name="radCSMungsinhnhat" id="radCSMungsinhnhat1" runat="server" type="radio" />
                                </li>
                                <li class="w10">Không 
                                    <input name="radCSMungsinhnhat" id="radCSMungsinhnhat2" runat="server" type="radio" />
                                </li>
                            </ul>
                        </div>
                        <div class="ks_csphucloi">
                            <ul>
                                <li class="w60"><span style="margin-left:20px;margin-right:15px;">-</span>Chính sách mua bảo hiểm TN 24/24, BH cao cấp
                                </li>
                                <li class="w10">: Có
                                    <input name="radCSMuabaohiem" id="radCSMuabaohiem1" runat="server" type="radio" />
                                </li>
                                <li class="w10">Không 
                                    <input name="radCSMuabaohiem" id="radCSMuabaohiem2" runat="server" type="radio" />
                                </li>
                            </ul>
                        </div>
                        <div class="ks_csphucloi">
                            <ul>
                                <li class="w60"><span style="margin-left:20px;margin-right:15px;">-</span>Chính sách đào tạo, tài trợ học phí, tặng học bổng
                                </li>
                                <li class="w10">: Có
                                    <input name="radCSdaotaotaitro" id="radCSdaotaotaitro1" runat="server" type="radio" />
                                </li>
                                <li class="w10">Không 
                                    <input name="radCSdaotaotaitro" id="radCSdaotaotaitro2" runat="server" type="radio" />
                                </li>
                            </ul>
                        </div>
                        <div class="ks_csphucloi">
                            <ul>
                                <li class="w60"><span style="margin-left:20px;margin-right:15px;">-</span>Chính sách khám sức khỏe định kỳ hàng năm
                                </li>
                                <li class="w10">: Có
                                    <input name="radCSKhamsuckhoedinhky" id="radCSKhamsuckhoedinhky1" runat="server" type="radio" />
                                </li>
                                <li class="w10">Không 
                                    <input name="radCSKhamsuckhoedinhky" id="radCSKhamsuckhoedinhky2" runat="server" type="radio" />
                                </li>
                            </ul>
                        </div>
                        <div class="ks_csphucloi">
                            <ul>
                                <li class="w60"><span style="margin-left:20px;margin-right:15px;">-</span>Chính sách mua hàng trả góp không lãi suất
                                </li>
                                <li class="w10">: Có
                                    <input name="radCSmuahangtragop" id="radCSmuahangtragop1" runat="server" type="radio" />
                                </li>
                                <li class="w10">Không 
                                    <input name="radCSmuahangtragop" id="radCSmuahangtragop2" runat="server" type="radio" />
                                </li>
                            </ul>
                        </div>
                        <div class="ks_csphucloi">
                            <ul>
                                <li class="w60"><span style="margin-left:20px;margin-right:15px;">-</span>Chính sách du lịch hàng năm, đột xuất
                                </li>
                                <li class="w10">: Có
                                    <input name="radCSdulichhangnam" id="radCSdulichhangnam1" runat="server" type="radio" />
                                </li>
                                <li class="w10">Không 
                                    <input name="radCSdulichhangnam" id="radCSdulichhangnam2" runat="server" type="radio" />
                                </li>
                            </ul>
                        </div>
                        <div class="ks_csphucloi">
                            <ul>
                                <li class="w40"><span style="margin-left:20px;margin-right:15px;">-</span>Chính sách khác: (liệt kê nếu biết) </li>
                                <li class="w55">
                                    <input class="ips" id="chinhsachkhac" runat="server" />
                                </li>
                            </ul>
                        </div>

                        <div class="ks_title">
                            <strong style="margin-right:10px;">III.</strong><strong style="text-decoration:underline">TIÊU CHÍ TÌM VIỆC</strong>
                        </div>
                        <div class="ks_csphucloi">
                            <ul>
                                <li><span style="margin-left:20px;margin-right:15px;">-</span>Lựa chọn <strong style="font-style:italic">mức ưu tiên</strong> các tiêu chí  theo số thứ tự 1,2,3,4,5</li>
                            </ul>
                        </div>
                        <div class="ks_csphucloi">
                            <ul>
                                <li class="w20"><span style="margin-left:20px;margin-right:15px;">-</span>Công việc
                                    <input class="ips w15" id="tcCongviec" runat="server" /></li>
                                <li class="w20">môi trường
                                    <input class="ips w15" id="tcMoitruong" runat="server" /></li>
                                <li class="w20">nơi làm việc
                                    <input class="ips w15" id="tcNoilamviec" runat="server" /></li>
                                <li class="w20">thu nhập
                                    <input class="ips w15" id="tcThunhap" runat="server" /></li>
                                <li class="w20">chính sách
                                    <input class="ips w15" id="tcChinhsach" runat="server" /></li>
                            </ul>
                        </div>
                         <div class="ks_csphucloi">
                            <ul>
                                <li class="w30"><span style="margin-left:20px;margin-right:15px;">-</span>Tiêu chí cá nhân khác: </li>
                                <li class="w60">
                                    <input class="ips" id="tcCanhankhac" runat="server" />
                                </li>   
                            </ul>
                        </div>

                          <div class="ks_title">
                            <strong style="margin-right:10px;">IV.</strong><strong style="text-decoration:underline">NGUYỆN VỌNG CÁ NHÂN</strong>
                        </div>
                        <div class="ks_csphucloi">
                            <ul>
                                <li class="w100">Nêu nguyện vọng cá nhân khi đi phỏng vấn</li> 
                            </ul>
                        </div>
                          <div class="ks_csphucloi">
                            <ul>
