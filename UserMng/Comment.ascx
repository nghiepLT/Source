...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tbody>
        <tr>
            ...
            <td class="R">
                <asp:Button ID="btnActive" runat="server" Text="Cập nhật" OnClick="btnActive_Click" CssClass="btn-1"></asp:Button>&nbsp;&nbsp;
...
<div class="TboardBox">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <th class="RB_L" width="20%">
                <asp:Label ID="Label19" runat="server" Text="Bình luận" Font-Bold="true"></asp:Label>
            </th>
            <td class="B_L">
        ...
        <tr id="divRely" runat="server" visible="false">
            ...
            <td class="B_L">
                <FCKeditorV2:FCKeditor ID="txtContent" BasePath="/Include/Object _basic/fckeditor/" ToolbarSet="Basic"
                    Height="500px" Width="100%" runat="server">
                </FCKeditorV2:FCKeditor>
                <%--<asp:TextBox ID="txt_comment" runat="server" TextMode="MultiLine" Width="100%" Height="20px"></asp:TextBox>--%>
                <br />
                <asp:Button ID="btnSave" runat="server" Text="Cập nhật" OnClick="btnSave_Click" CssClass="btn-1"></asp:Button>&nbsp;&nbsp;
            </td>
        </tr>
    </table>
    <br />
    ...
    <div id="divBoxRely" runat="server">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td class="Line2">
            </td>
