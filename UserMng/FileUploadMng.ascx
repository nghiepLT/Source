...
<div class="TboardBox">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <td class="RB_L">
                <asp:FileUpload ID="fileUrl01" runat="server" Width="30%" Height="20px" />
            </td>
            <th width="15%" class="RB_L">
                <asp:Label ID="lblFile02" runat="server" Text="Upload File"></asp:Label>
            </th>
            <td class="RB_L">
                <asp:FileUpload ID="fileUrl02" runat="server" Width="30%" Height="20px" />
            </td>
        </tr>
        <tr>
            <th width="15%" class="RB_L">
        ...
        <tr>
            ...
            <td class="RB_L">
                <asp:FileUpload ID="fileUrl03" runat="server" Width="30%" Height="20px" />
            </td>
            <th width="15%" class="RB_L">
                <asp:Label ID="lblFile04" runat="server" Text="Upload File"></asp:Label>
            </th>
            <td class="RB_L">
                <asp:FileUpload ID="fileUrl04" runat="server" Width="30%" Height="20px" />
            </td>
        </tr>
        <tr>
            <th width="15%" class="RB_L">
