...
<div class="TboardBox">
        ...
        <tr>
          <th width="20%" class="RB_L">
            ...
            <td class="B_L" colspan="3">
                <asp:TextBox ID="txtUsername" runat="server" CssClass="Input_text" Width="200px"></asp:TextBox>
            </td>
            <th width="20%" class="RB_L" id="tr_leveluser" runat="server">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="tbttNhanvien"
        ...
        <tr id="tr2" runat="server">
            ...
            <td class="B_L" width="30%">
                <asp:TextBox ID="txt_ngaycapcmnd" ReadOnly="true" runat="server" CssClass="Input_text" Width="50%"></asp:TextBox>
                ...
                <table onmouseover="return ShowImage(event, 1);" onmouseout="return ShowImage(event, 0);">
                    <tr>
                        <td>
                             ...
                             <asp:Image ID="img_user" runat="server" width="50px" height="60px"  />
                        </td>
                    </tr>
                </table>                
            </td>
