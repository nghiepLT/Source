...
namespace NewsMng
{
    public partial class CategoryInfo02 : XVNET_ModuleControl
    {
        ...
        private bool CheckLinkUrlField()
        {
            if (Helper.ValidateParam("LinkUrl", string.Empty) == "LinkUrl")
            {
        ...
        private void BindRootCategory()
        {
            ...
            if (!string.IsNullOrEmpty(this.StrProID))
            {
                ...
                txtKetWord.Text = this.StrProID.Trim();
        ...
        private void BindCategoryInfo()
        {
            ...
            if (treeCategory.SelectedNode != null || this.IsAlone == 1)
            {
                ...
                if (ent != null)
                {
                    ...
                    ////LinkUrl
                    if (CheckLinkUrlField() == true)
                    {
                        txtUrk.Text = string.Format("{0}{1}{2}/{3}.html", HttpContext.Current.Request.Url.Host, Config.GetConfigValue("LinkUrl"), this.NewsCategoryID, Ultils.ConvertUrlText("thông tin"));
                    }
                }
            }
            if (divmeta.Visible == true)
        ...
        protected void treeCategory_SelectedNodeChanged(object sender, EventArgs e)
        {
            ...
            //if (CheckLinkUrlField() == true)
            //{
            //    txtUrk.Text = HttpContext.Current.Request.Url.Host.ToString();
            //}
        }
        ...
        protected void btnInsert_Click(object sender, EventArgs e)
        {
            ...
            tbmlName.Reload();
            txtUrk.Text = string.Empty;
            txtKetWord.Text = string.Empty;
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dt1.Rows.Count > 0)
                {
                    Alert.Show("This category have children category, can not delete.");
                }
