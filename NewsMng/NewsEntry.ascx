...
<div class="TboardBox">
    ...
    <div id="divData">
        ...
        <div style="display: none;">
            <pqt:TextBoxMultiLanguage ID="txtSubTitle" TextWidth="95%" Title="Tiêu đề phụ" TitleWidth="15%"
                runat="server" />
        </div>
        <table width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr id="div_downloadTitle" runat="Server">
                <th class="RB_L" width="20%">
                    <asp:Label ID="Label19" runat="server" Text="Link Download" Font-Bold="true"></asp:Label> <%--Author--%>
                </th>
                <td class="B_L">
        ...
        <pqt:TextBoxMultiLanguage ID="tbmlSubTitle" Visible="false" TextMode="SingleLine"
            Title="SubTitle" TextWidth="95%" TitleWidth="15%" runat="server" />
        ...
        <div id="styleMota" runat="Server">
            <pqt:TextBoxMultiLanguage ID="tbmlSubContent" TextHeight="60px" Title="Mô tả"
            ...
            TitleWidth="15%" runat="server" />--%>
             <Nck:ckeditor  ID="fckmlMetaDescription_CK" runat="server"  TextHeight="600px" Title="Nội Dung" TextWidth="95%"
                TitleWidth="15%"/>
        </div>
